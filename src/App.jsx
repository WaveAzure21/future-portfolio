...
const Projects = () => {
  const projects=[
    ...
    {title:"Momentum", tags:["Next.js","TypeScript","Supabase"], desc:"My first project, built during NS to stay disciplined without overthinking my routine. A clean ad-free habit tracker with streak counting and progress visualization.", year:"2025",accentColor:ACCENT2, url:"https://habit-tracker-eosin-zeta.vercel.app"},
  ];
  return (
